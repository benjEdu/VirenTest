...
public class HashSaltTest {
    ...
    private static final String salt = "ae62ef0054a04afc9f06aeede4341b30";
    ...
    public static void main(String[] args){
        ...
        if(testPasswordHashing(password, salt, correctHashedPassword)){
            System.out.println("Hashing des Passworts funktioniert :)");
        }
        
    }
    
    public static boolean testSaltGeneration(){
